...
parser <- ArgumentParser()
	...
	parser$add_argument('--multithread', default= T, help='(Optional). Default is TRUE. If TRUE, multithreading is enabled and the number of available threads is automatically determined. If an integer is provided, the number of threads to use is set by passing the argument on to setThreadOptions.')
...
# Save
write.table(taxa, args$output, sep="\t")
